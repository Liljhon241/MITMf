...
#!/usr/bin/env bash
#In case you do not have pip utility and setuptools installed: apt-get install python-pip
...
echo -e "\e[31mGit submodule...\e[0m"
git submodule init && git submodule update --recursive
echo -e "\e[31mRecommended packages...\e[0m"
apt-get install -y python-dev python-setuptools libpcap0.8-dev libnetfilter-queue-dev
echo -e "\e[31mCapstone, Twisted, Requests, Scapy, Dnspython, Cryptography, Crypto...\e[0m"
...
echo -e "\e[31mMsgpack, Configobj, Pefile, Ipy, Openssl, Pypcap...\e[0m"
...
echo -e "\e[31mMitmflib setup...\e[0m"
